...
* **Arquitetura:** Entenda como os diferentes tipos de arquitetura de processadores (x64, ARM) podem impactar os custos. Entenda como cada serviço do Cloud Provider funciona para escolher o melhor recurso para a sua aplicação (EC2 vs Lambda, por exemplo).
...
Transforme esses hábitos em rotina desde já: eles fazem toda a diferença quando você começar a operar contas cloud reais.

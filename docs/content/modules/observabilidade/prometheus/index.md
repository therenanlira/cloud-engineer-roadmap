...
* <i class="fas fa-video"></i> **Vídeo (Metrics e AlertManager):** [[Fabricio Veronez] Prometheus + AlertManager no Kubernetes: Monitoramento além do dashboard](https://youtu.be/NTRLWcryaCA)
* <i class="fas fa-video"></i> **Vídeo (consultas avançadas):** [[Fabricio Veronez] Guia Prático de PromQL: Aprenda do Zero a Consultar Métricas no Prometheus](https://youtu.be/U8_lQBbQQow)

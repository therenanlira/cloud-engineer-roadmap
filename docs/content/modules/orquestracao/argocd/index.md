...
ArgoCD é uma das ferramentas de GitOps mais populares. GitOps é o modelo de implantação contínua baseado no Git como única fonte de verdade. Com esse modelo, as mudanças em infraestrutura, como em Kubernetes, ocorrem via Git.
...
> Para os estudos e exercícios, **não crie um cluster na nuvem** (como EKS). Utilize ferramentas como o **[Minikube]({{ '/content/guides/ferramentas-locais/#minikube' | relative_url }})**. Elas rodam um cluster Kubernetes completo localmente na sua máquina, permitindo que você estude e erre de graça.
